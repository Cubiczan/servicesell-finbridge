...
See `executas/chp-workflow/SKILL.md` for the full CHP recipe. Root skill exists so agents that look for `SKILL.md` at the repo root can load the same workflow.
